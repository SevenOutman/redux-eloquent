...
export default class Query<T extends Model = Model> {
   ...
   */
  module: Redux.Reducer<State, any>
   ...
   */
  static getModule (name: string): Redux.Reducer<State, any> {
   ...
   */
  static getModules (): Redux.ReducersMapObject {
   ...
   * Get module of given name from the container.
   */
  getModule (name?: string): Redux.Reducer<State, any> {
    const entity = name || this.entity
   ...
   * Get all modules from the container.
   */
  getModules (): Redux.ReducersMapObject {
